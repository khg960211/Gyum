...
class DrivingSimulator:
    ...
    def __str__(self):
        ...
        speed_info = ""
        for vehicle in self.vehicles:
            speed_info += str(vehicle) + "\n"
        # for i in range(len(self.vehicleList) - 1):
        #     speed_info = speed_info + str(self.vehicleList[i]) + "\n"
        # speed_info = speed_info + str(self.vehicleList[len(self.vehicleList) -1])
